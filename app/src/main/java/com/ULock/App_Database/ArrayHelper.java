...
// Class to save the locked app in array using share preference
...
// method to save JSON object if JSON object is passed
    ...
    // method to save JSON Array if JSON Array is passed
...
// method to load/call JSON object if JSON object is called
    public static JSONObject loadJSONObject(Context c, String prefName, String key) throws JSONException {
        SharedPreferences settings = c.getSharedPreferences(prefName, 0);
        return new JSONObject(settings.getString(ArrayHelper.PREFIX+key, "{}"));
    }
// method to load/call JSON Array if JSON Array is called
...
//method to save the locked app in an array list
    ...
    //method to save array data of app locked date
    ...
    //method to save array data of app remove date
    ...
    //method to save app reference according to start time
    ...
    //method to save app reference according to end time that is after the app is removed
    ...
    //method to save app reference that app has been removed
    ...
    //method to save app reference that app has been installed
    ...
    // method to get JSON Array of app removed date
    ...
    // method to get JSON Array of app installed date
    ...
    // method to get JSON Array of app last use date
    ...
    // method to get JSON Array of app use date
